  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    ...
    await queryInterface.bulkInsert('users', [
      ...
      {
        id: 4,
        username: 'EmpresaJohn',
        email: 'empresa.john@example.com',
        password: hashedTesterPassword,
        nombres: 'John',
        apellido: 'Doe',
        foto_perfil: null,
        descripcion: 'Empresa de John',
        token: null,
        is_active: true,
      ...
      {
        id: 5,
        username: 'EmpresaJohn2',
        email: 'empresa2.john@example.com',
        password: hashedTesterPassword,
        nombres: 'Sidee',
        apellido: 'hon',
        foto_perfil: null,
        descripcion: 'Empresa de John2',
        token: null,
        is_active: true,
      ...
      {
        id: 6,
        username: 'ClienteJane',
        email: 'cliente.jane@example.com',
        password: hashedTesterPassword,
        nombres: 'Jane',
        apellido: 'Smith',
        foto_perfil: null,
        descripcion: 'Persona divertida para experiencias nuevas',
        token: null,
        is_active: true,

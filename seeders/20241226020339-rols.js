...
module.exports = {
  async up (queryInterface, Sequelize) {
   ...
   const rolsData = [
    ...
    { id:4,rol:'Empresa', description: 'Rol para permisos de empresas', is_active:true, createdAt: new Date()}, 
    { id:5,rol:'Cliente', description: 'Rol para permisos de clientes', is_active:true, createdAt: new Date()}, 
   ];

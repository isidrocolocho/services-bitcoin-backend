  ...
  async up (queryInterface, Sequelize) {
    ...
    */
    const groupsData = [
      ...
      { id:8,group:'Dias o Tipos', description: 'Grupo para ver los permisos de administracion de dias o tipos', is_active:true, createdAt:new Date()},
      ...
      { id:13,group:'Servicios o Productos', description: 'Grupo para ver los permisos de los servicios o productos ', is_active:true, createdAt:new Date()},

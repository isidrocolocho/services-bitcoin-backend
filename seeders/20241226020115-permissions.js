...
{ id:48,id_group:8, permission:'listar_dia_tipo' ,description: 'Listar los dias o tipos', is_active:true, createdAt:new Date()},
{ id:49,id_group:8, permission:'mostrar_dia_tipo' ,description: 'Mostrar un dia o tipo', is_active:true, createdAt:new Date()},
{ id:50,id_group:8, permission:'crear_dia_tipo' ,description: 'Crear dia o tipo', is_active:true, createdAt:new Date()},
{ id:51,id_group:8, permission:'actualizar_dia_tipo' ,description: 'Actualizar dia o tipo', is_active:true, createdAt:new Date()},
{ id:52,id_group:8, permission:'borrar_dia_tipo' ,description: 'Borrar dia o tipo', is_active:true, createdAt:new Date()},
{ id:53,id_group:8, permission:'menu_dia_tipo' ,description: 'Mostrar en menu gestion de dias o tipos', is_active:true, createdAt:new Date()},
{ id:54,id_group:9, permission:'listar_categoria' ,description: 'Listar las categorias', is_active:true, createdAt:new Date()},
{ id:55,id_group:9, permission:'mostrar_categoria' ,description: 'Mostrar un categoria', is_active:true, createdAt:new Date()},
{ id:56,id_group:9, permission:'crear_categoria' ,description: 'Crear categoria', is_active:true, createdAt:new Date()},
{ id:57,id_group:9, permission:'actualizar_categoria' ,description: 'Actualizar categoria', is_active:true, createdAt:new Date()},
{ id:58,id_group:9, permission:'desactivar_categoria' ,description: 'Desactivar categoria', is_active:true, createdAt:new Date()},
{ id:59,id_group:9, permission:'activar_categoria' ,description: 'Activar categoria', is_active:true, createdAt:new Date()},
{ id:60,id_group:9, permission:'borrar_categoria' ,description: 'Borrar categoria', is_active:true, createdAt:new Date()},
{ id:61,id_group:9, permission:'menu_categoria' ,description: 'Mostrar en menu gestion de categoria', is_active:true, createdAt:new Date()},
{ id:62,id_group:10, permission:'listar_empresas' ,description: 'Listar los empresas', is_active:true, createdAt:new Date()},
{ id:63,id_group:10, permission:'mostrar_empresa' ,description: 'Mostrar un empresa', is_active:true, createdAt:new Date()},
{ id:64,id_group:10, permission:'crear_empresa' ,description: 'Crear empresa', is_active:true, createdAt:new Date()},
{ id:65,id_group:10, permission:'actualizar_empresa' ,description: 'Actualizar empresa', is_active:true, createdAt:new Date()},
{ id:66,id_group:10, permission:'desactivar_empresa' ,description: 'Desactivar empresa', is_active:true, createdAt:new Date()},
{ id:67,id_group:10, permission:'activar_empresa' ,description: 'Activar empresa', is_active:true, createdAt:new Date()},
{ id:68,id_group:10, permission:'borrar_empresa' ,description: 'Borrar empresa', is_active:true, createdAt:new Date()},
{ id:69,id_group:10, permission:'menu_empresa' ,description: 'Mostrar en menu gestion de empresa', is_active:true, createdAt:new Date()},
{ id:70,id_group:11, permission:'listar_encargados' ,description: 'Listar los encargados', is_active:true, createdAt:new Date()},
{ id:71,id_group:11, permission:'mostrar_encargado' ,description: 'Mostrar un encargados', is_active:true, createdAt:new Date()},
{ id:72,id_group:11, permission:'crear_encargado' ,description: 'Crear encargado', is_active:true, createdAt:new Date()},
{ id:73,id_group:11, permission:'actualizar_encargado' ,description: 'Actualizar encargado', is_active:true, createdAt:new Date()},
{ id:74,id_group:11, permission:'desactivar_encargado' ,description: 'Desactivar encargado', is_active:true, createdAt:new Date()},
{ id:75,id_group:11, permission:'activar_encargado' ,description: 'Activar encargado', is_active:true, createdAt:new Date()},
{ id:76,id_group:11, permission:'borrar_encargado' ,description: 'Borrar encargado', is_active:true, createdAt:new Date()},
{ id:77,id_group:11, permission:'menu_encargado' ,description: 'Mostrar en menu gestion de encargado', is_active:true, createdAt:new Date()},
...
{ id:86,id_group:13, permission:'listar_servicios_productos' ,description: 'Listar los servicios o productos', is_active:true, createdAt:new Date()},
{ id:87,id_group:13, permission:'mostrar_servicio_producto' ,description: 'Mostrar un servicio o producto', is_active:true, createdAt:new Date()},
{ id:88,id_group:13, permission:'crear_servicio_producto' ,description: 'Crear servicio o producto', is_active:true, createdAt:new Date()},
{ id:89,id_group:13, permission:'actualizar_servicio_producto' ,description: 'Actualizar servicio o producto', is_active:true, createdAt:new Date()},
{ id:90,id_group:13, permission:'desactivar_servicio_producto' ,description: 'Desactivar servicio o producto', is_active:true, createdAt:new Date()},
{ id:91,id_group:13, permission:'activar_servicio_producto' ,description: 'Activar servicio o producto', is_active:true, createdAt:new Date()},
{ id:92,id_group:13, permission:'borrar_servicio_producto' ,description: 'Borrar servicio o producto', is_active:true, createdAt:new Date()},
{ id:93,id_group:13, permission:'menu_servicio_producto' ,description: 'Mostrar en menu gestion de servicio o producto', is_active:true, createdAt:new Date()},
...
{ id:100,id_group:15, permission:'listar_agenda_empresa' ,description: 'Listar los agendas empresas', is_active:true, createdAt:new Date()},
{ id:101,id_group:15, permission:'mostrar_agenda_empresa' ,description: 'Mostrar un agenda empresa', is_active:true, createdAt:new Date()},
{ id:102,id_group:15, permission:'crear_agenda_empresa' ,description: 'Crear agenda empresa', is_active:true, createdAt:new Date()},
{ id:103,id_group:15, permission:'actualizar_agenda_empresa' ,description: 'Actualizar agenda empresa', is_active:true, createdAt:new Date()},
{ id:104,id_group:15, permission:'borrar_agenda_empresa' ,description: 'Borrar agenda empresa', is_active:true, createdAt:new Date()},
{ id:105,id_group:15, permission:'menu_agenda_empresa' ,description: 'Mostrar en menu gestion de agenda empresa', is_active:true, createdAt:new Date()}, 
{ id:106,id_group:16, permission:'dashboard_empresa' ,description: 'Dashboard de empresa', is_active:true, createdAt:new Date()},
{ id:107,id_group:16, permission:'citas_atendidas_empresa' ,description: 'Citas atendidas de empresa', is_active:true, createdAt:new Date()},
{ id:108,id_group:16, permission:'calificacion_empresa' ,description: 'Calificaciones de los empresas', is_active:true, createdAt:new Date()},
{ id:109,id_group:16, permission:'proxima_cita_empresa' ,description: 'Proxima cita de empresas', is_active:true, createdAt:new Date()},
{ id:110,id_group:1, permission:'ver_perfil' ,description: 'Ver perfil de usuario ', is_active:true, createdAt:new Date()},
{ id:111,id_group:17, permission:'catalogo_cliente_empresa' ,description: 'clientes ven catalogo de empresa ', is_active:true, createdAt:new Date()},
{ id:112,id_group:17, permission:'crear_cita_cliente' ,description: 'Menu de crear cita el cliente', is_active:true, createdAt:new Date()},
{ id:113,id_group:17, permission:'citas_anteriores_cliente' ,description: 'Menu de cita ateriores del cliente', is_active:true, createdAt:new Date()},
{ id:114,id_group:17, permission:'calendario' ,description: 'cliente ve calendario de empresa', is_active:true, createdAt:new Date()},
];
